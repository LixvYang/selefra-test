...
//
// Solidity: function burn(uint256 _amount) returns(bool success)
...
//
// Solidity: function mint(uint256 _amount) returns(bool success)
...
//
// Solidity: event Approve(address indexed owner, address indexed spender, uint256 value)
func (_Token *TokenFilterer) FilterApprove(opts *bind.FilterOpts, owner []common.Address, spender []common.Address) (*TokenApproveIterator, error) {
	...
	logs, sub, err := _Token.contract.FilterLogs(opts, "Approve", ownerRule, spenderRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event Approve(address indexed owner, address indexed spender, uint256 value)
func (_Token *TokenFilterer) WatchApprove(opts *bind.WatchOpts, sink chan<- *TokenApprove, owner []common.Address, spender []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Token.contract.WatchLogs(opts, "Approve", ownerRule, spenderRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event Approve(address indexed owner, address indexed spender, uint256 value)
func (_Token *TokenFilterer) ParseApprove(log types.Log) (*TokenApprove, error) {
	event := new(TokenApprove)
	if err := _Token.contract.UnpackLog(event, "Approve", log); err != nil {
		return nil, err
	}
